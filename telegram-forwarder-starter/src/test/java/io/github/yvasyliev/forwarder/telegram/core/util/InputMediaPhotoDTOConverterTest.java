...
class InputMediaPhotoDTOConverterTest {
    private static final InputMediaPhotoDTOConverter CONVERTER = new InputMediaPhotoDTOConverter();
    ...
    void testConvert() throws IOException {
        ...
        @Cleanup var expected = new InputMediaPhotoDTO(inputStream, filename, null);
