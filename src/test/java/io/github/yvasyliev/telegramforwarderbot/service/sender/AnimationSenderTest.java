...
class AnimationSenderTest {
    ...
    @Test
    void testSendAnimation() throws IOException, TelegramApiException {
        ...
        var actual = sender.sendAnimation(new InputFileDTO(fileSupplier, filename, hasSpoiler), caption);
