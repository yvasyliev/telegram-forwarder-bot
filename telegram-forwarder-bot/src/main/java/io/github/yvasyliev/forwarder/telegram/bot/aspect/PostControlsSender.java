...
public class PostControlsSender {
     ...
     */
    @AfterReturning(
            pointcut = "io.github.yvasyliev.forwarder.telegram.bot.util.Pointcuts.sendPost()",
            returning = "message"
    )
     ...
     */
    @AfterReturning(
            pointcut = "io.github.yvasyliev.forwarder.telegram.bot.util.Pointcuts.sendMediaGroup()",
            returning = "messages"
    )
