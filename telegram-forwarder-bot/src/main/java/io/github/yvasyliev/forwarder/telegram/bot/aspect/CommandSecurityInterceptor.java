...
public class CommandSecurityInterceptor {
     ...
     */
    @Around("io.github.yvasyliev.forwarder.telegram.bot.util.Pointcuts.handleMessageEvent() && args(message)")
     ...
     * @throws Throwable if any error occurs during method execution
     */
    @Around("io.github.yvasyliev.forwarder.telegram.bot.util.Pointcuts.handleCallbackQueryEvent() && args(query)")
