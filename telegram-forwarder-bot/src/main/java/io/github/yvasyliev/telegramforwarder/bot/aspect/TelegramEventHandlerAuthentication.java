...
public class TelegramEventHandlerAuthentication {
     ...
     */
    @Before("io.github.yvasyliev.telegramforwarder.bot.util.Pointcuts.handleMessageEvent() && args(message)")
     ...
     */
    @Before("io.github.yvasyliev.telegramforwarder.bot.util.Pointcuts.handleCallbackQueryEvent() && args(query)")
