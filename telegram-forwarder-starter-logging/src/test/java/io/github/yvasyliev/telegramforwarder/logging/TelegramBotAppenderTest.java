...
class TelegramBotAppenderTest {
    ...
    @BeforeEach
    void setUp() {
        telegramBotAppender = new TelegramBotAppender(telegramClient, templateEngine, CHAT_ID, patternLayout);
    ...
    void shouldNotLogError() throws TelegramApiException {
        ...
        when(response.getErrorCode()).thenReturn(HttpURLConnection.HTTP_FORBIDDEN);
